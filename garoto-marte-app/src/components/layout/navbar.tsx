...
export function Navbar() {
    ...
    return (
        <header className="bg-[#000000CC] text-white sticky top-0 z-40 border-b border-gray-900">            <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 md:px-8" aria-label="Global">
            ...
            </div>                {/* Desktop navigation - Left Section with Logo */}
